...
// Obtener cursos
$sql = "SELECT id_curso, curso, fecha_inicio, fecha_fin FROM cursos";
...
<body>
    ...
    <ul>
        <?php while($row = $result->fetch_assoc()): ?>
            <li>
                <?php echo $row['curso'] . " - Desde: " . $row['fecha_inicio'] . " Hasta: " . $row['fecha_fin']; ?>
                <button onclick="showForm('<?php echo $row['curso']; ?>')">Inscribirse</button>
            </li>
        <?php endwhile; ?>
    </ul>
    ...
    <script>
        ...
        function submitForm() {
            ...
            xhr.open("POST", "inscribir_curso.php", true);
            xhr.onload = function () {
